      ...
      <div className="aboutMe_content">
        <div className="text_container">
          <p>
            ...
            myselfdeeply fullfilled with developing web pages and mobile
            applications.
          </p>
          <p>
            {" "}
            🖇️ In particular, I am interested in pursuing a career as a Front
            end Developer
          </p>
          <p>
            {" "}
          ...
          <p>
            ...
            music, painting or watching movies and last but not least
